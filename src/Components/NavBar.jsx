        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          ...
          <div className=" md:flex items-center">
            <input
              type="text"
              placeholder="Search"
              className="input rounded p-1 input-bordered w-16 md:w-24"
            />
            ...
            <button className="ml-4 px-4 py-2 bg-purple-700 text-white rounded hover:bg-slate-100 hover:text-purple-700 hidden md:block ">
              Login
            </button>
